...
#we would never store pw's like this in the db, but this is an example.

#later will use actionpack to secure the pw's

Person.create! [
  {first_name: "John", last_name: "Kalman", age: 33, login: "kman", pass: "abc123" },
